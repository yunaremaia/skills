...
It also needs [grilling](https://aihero.dev/skills-grilling) and [domain-modeling](https://aihero.dev/skills-domain-modeling) installed: naming the destination calls both, and every decision ticket on the map is worked as a grilling session.
